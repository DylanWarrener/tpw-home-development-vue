...
export default defineComponent({
	...
	computed: {
		...
		title(): string {
			return this.$t("main.card.pages.refurbishment.title");
		},
		subtitle(): string {
			return this.$t("main.card.pages.refurbishment.subtitle");
		},
		btnText(): string {
			return this.$t("main.card.pages.refurbishment.btnText");
		},
	},
	setup() {
